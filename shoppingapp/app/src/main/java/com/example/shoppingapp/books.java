    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar1.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                intent_tool=new Intent(books.this,MainActivity.class);
        ...
        good.setName(name);
        good.setImageId(R.drawable.books);
        double danjia=250.00;
        UserService sg=new UserService(books.this);
        btn_addcar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (f.getFlag()!=1)
                {
                    Toast.makeText(books.this,"请先登录",Toast.LENGTH_SHORT).show();
                    Intent intent_orange=new Intent(books.this,UserActivity.class);
                    ...
                    if(sg.chaxun(good,f.getName()))
                    {
                        ...
                        Toast.makeText(books.this,"成功加入购物车",Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
...
//                    Toast.makeText(orange.this,good.getName()+good.getPrice()+good.getNumber(),Toast.LENGTH_SHORT).show();
                ...
                {
                    Intent intent_shop=new Intent(books.this,submit.class);
