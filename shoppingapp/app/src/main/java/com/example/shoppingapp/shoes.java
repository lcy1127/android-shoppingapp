    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar1.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                intent_tool=new Intent(shoes.this,MainActivity.class);
        ...
        good.setImageId(R.drawable.shoes_1);
        UserService sg=new UserService(shoes.this);
        double danjia=180.00;
        btn_addcar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (f.getFlag()!=1)
                {
                    Toast.makeText(shoes.this,"请先登录",Toast.LENGTH_SHORT).show();
//                    Toast.makeText(orange.this,good.getName()+good.getPrice()+good.getNumber(),Toast.LENGTH_SHORT).show();
                    Intent intent_orange=new Intent(shoes.this,UserActivity.class);
                    ...
                    if(sg.chaxun(good,f.getName()))
                    {
                        ...
                        Toast.makeText(shoes.this,"成功加入购物车",Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
...
//                    Toast.makeText(orange.this,good.getName()+good.getPrice()+good.getNumber(),Toast.LENGTH_SHORT).show();
                ...
                {
                    Intent intent_shop=new Intent(shoes.this,submit.class);
