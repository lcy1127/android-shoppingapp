...
public class dish extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar1.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                intent_tool=new Intent(dish.this,MainActivity.class);
    ...
    good.setName(name);
    good.setPrice(price);
    good.setImageId(R.drawable.dish);
    UserService sg=new UserService(dish.this);
    ...
    btn_addcar.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (f.getFlag()!=1)
            {
                Toast.makeText(dish.this,"请先登录",Toast.LENGTH_SHORT).show();
//                    Toast.makeText(orange.this,good.getName()+good.getPrice()+good.getNumber(),Toast.LENGTH_SHORT).show();
                Intent intent_orange=new Intent(dish.this,UserActivity.class);
                ...
                if(sg.chaxun(good,f.getName()))
                {
                    ...
                    Toast.makeText(dish.this,"成功加入购物车",Toast.LENGTH_SHORT).show();
                }
                else
                {
...
//                    Toast.makeText(orange.this,good.getName()+good.getPrice()+good.getNumber(),Toast.LENGTH_SHORT).show();
                ...
                {
                    Intent intent_shop=new Intent(dish.this,submit.class);
