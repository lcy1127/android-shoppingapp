    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar1.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                intent_tool=new Intent(iphone.this,MainActivity.class);
        ...
        good.setName(name);
        good.setPrice(price);
        good.setImageId(R.drawable.iphone);
        UserService sg=new UserService(iphone.this);
        double danjia=8388.00;
        btn_addcar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (f.getFlag()!=1)
                {
                    Toast.makeText(iphone.this,"请先登录",Toast.LENGTH_SHORT).show();
//                    Toast.makeText(orange.this,good.getName()+good.getPrice()+good.getNumber(),Toast.LENGTH_SHORT).show();
                    Intent intent_orange=new Intent(iphone.this,UserActivity.class);
                    ...
                    if(sg.chaxun(good,f.getName()))
                    {
                        ...
                        Toast.makeText(iphone.this,"成功加入购物车",Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
...
//                    Toast.makeText(orange.this,good.getName()+good.getPrice()+good.getNumber(),Toast.LENGTH_SHORT).show();
                ...
                {
                    Intent intent_shop=new Intent(iphone.this,submit.class);
