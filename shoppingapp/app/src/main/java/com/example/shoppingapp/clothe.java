    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar1.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                intent_tool=new Intent(clothe.this,MainActivity.class);
        ...
        good.setPrice(price);
        good.setImageId(R.drawable.clothe_1);
        UserService sg=new UserService(clothe.this);
        double danjia=49.98;
        btn_addcar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (f.getFlag()!=1)
                {
                    Toast.makeText(clothe.this,"请先登录",Toast.LENGTH_SHORT).show();
//                    Toast.makeText(orange.this,good.getName()+good.getPrice()+good.getNumber(),Toast.LENGTH_SHORT).show();
                    Intent intent_orange=new Intent(clothe.this,UserActivity.class);
                    ...
                    if(sg.chaxun(good,f.getName()))
                    {
                        ...
                        Toast.makeText(clothe.this,"成功加入购物车",Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
...
//                    Toast.makeText(orange.this,good.getName()+good.getPrice()+good.getNumber(),Toast.LENGTH_SHORT).show();
                ...
                {
                    Intent intent_shop=new Intent(clothe.this,submit.class);
